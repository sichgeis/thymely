...
import eu.brokoko.thymely.domain.Project;
import eu.brokoko.thymely.repository.ProjectRepository;
...
/**
 * REST controller for managing {@link eu.brokoko.thymely.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
