...
import eu.brokoko.thymely.domain.Customer;
import eu.brokoko.thymely.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link eu.brokoko.thymely.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
