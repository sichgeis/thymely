...
import eu.brokoko.thymely.config.audit.AuditEventConverter;
import eu.brokoko.thymely.domain.PersistentAuditEvent;
...
import static eu.brokoko.thymely.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
